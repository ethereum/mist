...
let menuTempl = function(webviews) {
    ...
    if (global.mode !== "wallet") {
        swarmUpload.push(
            ...
            },
            {
                ...
                enabled:
                    store.getState().settings.swarmState == SwarmState.Enabled,
                click() {
                    ...
                    if (paths && paths.length === 1) {
                        ...
                        const uploadConfig = {
                            ...
                            defaultFile: fs.existsSync(defaultPath)
                                ? "/index.html"
                                : null
                        };
                        swarmNode
        ...
        submenu: [
            ...
            },
            {
                ...
                submenu: [
                    {
                        label: i18n.t(
                            "mist.applicationMenu.file.backupKeyStore"
                        ),
                        click() {
    ...
    const languageMenu = Object.keys(i18n.options.resources)
        ...
        .map(langCode => {
            const menuItem = {
                label: i18n.t(
                    `mist.applicationMenu.view.langCodes.${langCode}`
                ),
                type: "checkbox",
        ...
        submenu: [
            {
                ...
                click() {
                    ...
                    mainWindow.window.setFullScreen(
                        !mainWindow.window.isFullScreen()
                    );
                }
            },
            {
    ...
    devToolsMenu.push({
        ...
        submenu: [
            ...
            },
            {
                ...
                checked:
                    ethereumNode.isOwnNode && ethereumNode.network === "test",
                enabled: ethereumNode.isOwnNode,
                type: "checkbox",
                click() {
        ...
        devToolsMenu.push({
            ...
            click() {
                restartNode(
                    "geth",
                    null,
                    ethereumNode.isLightMode ? "fast" : "light"
                );
            }
        });
    }
