    ...
    !(function(e) {
        ...
        function n(e) {
            function a(e, n) {
                ...
                if (!(l instanceof a))
                    return (
                        z && x(26, "constructor call without new", e),
                        new a(e, n)
                    );
                if (null != n && V(n, 2, 64, C, "base")) {
                    if (((n = 0 | n), (s = e + ""), 10 == n))
                        return (
                            (l = new a(e instanceof a ? e : s)),
                            I(l, B + l.e + 1, P)
                        );
                    if (
            ...
            return (
                ...
                (M.minus = M.sub = function(e, n) {
                    ...
                    if (!f || !c) {
                        if (!h || !g)
                            return h ? ((e.s = -n), e) : new a(g ? s : NaN);
                        if (!h[0] || !g[0])
                            return g[0]
                                ? ((e.s = -n), e)
                                : new a(h[0] ? s : 3 == P ? -0 : 0);
                ...
                (M.plus = M.add = function(e, n) {
                    ...
                    if (!u || !s) {
                        ...
                        if (!l[0] || !f[0])
                            return f[0] ? e : new a(l[0] ? i : 0 * o);
                    }
                    if (
                        ((u = t(u)), (s = t(s)), (l = l.slice()), (o = u - s))
                    ) {
                        for (
                            o > 0 ? ((s = u), (r = f)) : ((o = -o), (r = l)),
                                r.reverse();
