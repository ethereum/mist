...
class Settings {
    ...
    init() {
        ...
        settingsLog.info(
            `Running in production mode: ${this.inProductionMode}`
        );
        ...
        store.dispatch(
            syncBuildConfig("productionMode", this.inProductionMode)
        );
...
const argv = require("yargs")
    ...
    .option({
        ...
        "ignore-gpu-blacklist": {
            demand: false,
            describe:
                "Ignores GPU blacklist (needed for some Linux installations).",
            requiresArg: false,
            nargs: 0,
            type: "boolean",
            group: "Mist options:"
