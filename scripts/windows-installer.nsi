...
!define GROUPNAME "wanchain"
!define HELPURL "https://github.com/wanchain/wanwallet/releases/issues"
!define UPDATEURL "https://github.com/wanchain/wanwallet/releases"
!define ABOUTURL "https://wanchain.org"
...
!macro ENVFUNC un
  Function ${un}setenv
    ...
    StrCpy $NODEDATADIR "$APPDATA\wanwallet"
...
Section Mist MIST_IDX
    ...
    #SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$DATADIR\binaries\Geth\unpacked\geth.exe" "" "" "wanwallet" "" 30303 "" ""
    #SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$DATADIR\binaries\Geth\unpacked\geth.exe" "" "" "wanwallet" "" 30303 "" ""
